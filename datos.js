function traerdatos() {
  ...
  document.body.getElementsByClassName("nombreregistro")[0].textContent =
    nombre_data;
  document.body.getElementsByClassName("emaildato")[0].textContent = email_data;
  document.body.getElementsByClassName("telefonodato")[0].textContent =
    telefono_data;
  document.body.getElementsByClassName("gusto")[0].textContent = gusto_data;
  document.body.getElementsByClassName("porcentaje")[0].textContent =
    porcentaje_data;
}
